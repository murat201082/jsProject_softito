...
function addUser(){
    ...
    if(UserList.some((category)=> category.CategoryName==UserName)){
        alert("User Already Exists");
        return;
    }

    const User=new Category(UserName);
    UserList.push(User);
...
function categoryUpdate(){
    ...
    selectCategory.innerHTML =`<option disabled value selected> -- Select Car --</option>`;
...
function UserUpdate(){
    ...
    UserList.forEach((category)=>{
        ...
        optionn.value=category.UserName;
        optionn.innerText=category.UserName;

        selectUser.add(optionn);
    });

    const CategoryProductListt=document.getElementById("UserList");
...
function addProduct(){
    const CategoryNamee=document.getElementById("SelectCategoryy").value;
    const ProductNamee=document.getElementById("ProductNamee").value.trim();
    const ProductPricee=document.getElementById("ProductPricee").value.trim();
    const ProductStockk=document.getElementById("ProductStockk").value.trim();
